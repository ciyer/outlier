...
def outlier_df(path):
    ...
    df_all = df_all[('2012-01-01' < df_all['Release']) & (df_all['Release'] < '2021-01-01') & (df_all['Price'] > 0)]
    ...
    df_all['Price-2020'] = df_all.apply(lambda x: price_adjusted(x['Price'], x['Year'], x['Month']), 1)
    return df_all
