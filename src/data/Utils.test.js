...
describe('urls', () => {
  ...
  it('Computes URLs for filtered releases', () => {
    ...
    return Data.read().then(releases => {
      ...
      const {outlierCcUrl, outlierNycUrl, archiveUrl} = outlierProductUrls(filteredReleases);
      expect(outlierCcUrl).toEqual(null);
      expect(outlierNycUrl).toEqual('https://shop.outlier.nyc/shop/retail/strong-dungarees.html');
